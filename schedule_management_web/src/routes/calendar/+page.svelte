<script>
   ...
   // Also, update the events array for displaying events in the checklist
   events = Object.values(eventsByDate).flat();
};
      ...
      <div class="calendar">
         ...
         <div class="modal {isModalOpen ? 'active' : ''}" on:click={closeModal}>
            <div class="modal-content">
               ...
               <button on:click={addSchedule} class="add-event-button">일정추가</button>
            </div>
         </div>
      </div>
   </div>
...
<style>
   ...
   .add-event-button {
      background-color: rgb(107, 107, 161); /* Example color: Blue */
        color: white;
        padding: 8px 16px;
        border: none;
        border-radius: 4px;
   ...
   .checklist-item button.edit-button {
      width: 50px;
      background-color: rgb(107, 107, 161); /* Change this to your desired color */
      color: white;
   }

   .checklist-item button.delete-button {
      background-color: rgb(107, 107, 161); /* Change this to your desired color */
      color: white;
   }
   ...
   .add-checklist-item button {
    background-color: rgb(107, 107, 161); /* Replace with your preferred color code */
    color: white;
    padding: 8px 16px;
    border: none;
    border-radius: 4px;
...
.add-checklist-item button:hover {
    background-color: rgb(107, 107, 161); /* Replace with your preferred hover color code */
}
