      ...
      <div class="modal-content" on:click={(e) => e.stopPropagation()}>
        ...
        {#if isSelectingDeadline}
          ...
          <div>
            ...
            <button on:click={() => selectDeadline(new Date(eventDetails.deadline))} style="background-color: rgb(107, 107, 161);">Select</button>
            <button on:click={cancelDeadlineSelection} style="background-color: rgb(107, 107, 161);">Cancel</button>
          </div>
        {:else}
          <!-- Display selected deadline -->
          <div>
            <span>{eventDetails.deadline}</span>
            <button on:click={openDeadlineSelector} style="background-color: rgb(107, 107, 161);">Change</button>
          </div>
        {/if}
        ...
        <div class="add-event-button">
          <button on:click={saveEvent} style="background-color: rgb(107, 107, 161);">Save</button>
          <button on:click={cancelAddEvent} style="background-color: rgb(107, 107, 161);">Cancel</button>
        </div>
        {:else}
        ...
        <div class="event-details-container">
          ...
          {#each eventDetails as event (event.eventName)}
            ...
            <div class="button-container">
              <button on:click={() => modifyEvent(event)} style="background-color:rgb(107, 107, 161);">Modify</button>
              <button on:click={() => deleteEvent(event)} style="background-color: rgb(107, 107, 161);">Delete</button>
            </div>
          {/each}
        </div>
  ...
  <div class="checklist-container">
    ...
    {#each goalList as goal}
      <div class="checklist-item">
        ...
        <div class="button-container">
          <form method="post">
            <button type="button" on:click={editGoal} style="background-color: rgb(107, 107, 161);">수정</button>
          <input name="id" type="text" value={goal.id} hidden>
          <button type="submit" onclick="alert('삭제되었습니다.')" formaction="?/deleteGoal" style="background-color: rgb(107, 107, 161);">삭제</button>
        </form>
        </div>
      </div>
    {/each}
    ...
    <div class="add-checklist-item">
      ...
      <button type="submit" style="background-color: rgb(107, 107, 161);">추가</button>
    </form>
